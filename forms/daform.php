...
<html>
    ...
    <div>
        ...
        <div>
            <img src="../Banners/doodleart.png" style="display: block; margin-left: auto; margin-right: auto; width:60%; border-radius: 5px;"></img>
        </div>
    </div>
  
    <div style="background-color: #c5f5ffff;  width:60%; height: 100%; margin-left: auto; margin-right: auto; margin-top: 25px; border-radius: 5px; border-top: solid #40ddffff 10px">
