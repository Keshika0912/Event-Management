...
if(isset($_POST['submit'])){
    ...
    $year=$_POST['year'];
    $regnum=$_POST['regnum'];
    $register_query = "INSERT INTO `paintform`(`fname`, `lname`, `email`, `phone`, `dept`, `year`, `regnum`) 
...
<html>
    ...
    <div>
        ...
        <div>
            <img src="../Banners/painting.png" style="display: block; margin-left: auto; margin-right: auto; width:60%; border-radius: 5px;"></img>
        </div>
    </div>
  
    <div style="background-color: #ffdff1ff;  width:60%; height: 100%; margin-left: auto; margin-right: auto; margin-top: 25px; border-radius: 5px; border-top: solid #ff60bcff 10px">
