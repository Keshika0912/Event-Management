...
if(isset($_POST['submit'])){
    ...
    $year=$_POST['year'];
    $regnum=$_POST['regnum'];
    $register_query = "INSERT INTO `sketchform`(`fname`, `lname`, `email`, `phone`, `dept`, `year`, `regnum`) 
...
<html>
    ...
    <div>
        ...
        <div>
            <img src="../Banners/sketching.png" style="display: block; margin-left: auto; margin-right: auto; width:60%; border-radius: 5px;"></img>
        </div>
    </div>
  
    <div style="background-color: #dffff9ff;  width:60%; height: 100%; margin-left: auto; margin-right: auto; margin-top: 25px; border-radius: 5px; border-top: solid #1fc8abff 10px">
