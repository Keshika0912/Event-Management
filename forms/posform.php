...
if(isset($_POST['submit'])){
    ...
    $year=$_POST['year'];
    $regnum=$_POST['regnum'];
    $register_query = "INSERT INTO `posform`(`fname`, `lname`, `email`, `phone`, `dept`, `year`, `regnum`) 
...
<html>
    ...
    <div>
        ...
        <div>
            <img src="../Banners/postermaking.png" style="display: block; margin-left: auto; margin-right: auto; width:60%; border-radius: 5px;"></img>
        </div>
    </div>
  
    <div style="background-color: #fff7d1ff;  width:60%; height: 100%; margin-left: auto; margin-right: auto; margin-top: 25px; border-radius: 5px; border-top: solid #ffe24dff 10px">
        ...
        <table align="center">
            ...
            <tr>
                <td style="margin-left: 40%; align:center"><input class="btn" type="submit" name="submit" value="REGISTER" id='alert' onclick="myFunction()" style="margin:20px ; justify-content: center; " ></td>
            </tr>
        </table>
        </form>
    </div>
